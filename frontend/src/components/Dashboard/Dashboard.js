            ...
            <table className="table">
              <tbody className='text-center'>
                <tr>
                  ...
                  <td>Name</td>
                  <td>{user.name}</td>
                  <td> <button className={`btn btn-secondary ${styles.editbtn}`}>Edit Username <i className="fa-solid fa-pen-to-square"></i></button></td>
                </tr>
                <tr>
                  <th scope="row">2</th>
                  <td>email</td>
                  <td className={styles.tolowercase}>{user.email}</td>
                  <td> <button className={`btn btn-secondary ${styles.editbtn}`}>Edit E-mail add. <i className="fa-solid fa-pen-to-square"></i></button></td>
                </tr>
                <tr>
                  <th scope="row">3</th>
                  <td>Role</td>
